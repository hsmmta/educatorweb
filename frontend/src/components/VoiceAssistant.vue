...
function handleIntent(text) {
  ...
  if (isIntro) {
    const intro = '智引未来是一个AI学习平台，包含五大核心功能：私人智库可以上传你的学习资料构建专属知识库；智能辅导提供三级检索的AI答疑；沉浸学习能够生成文档、PPT、题库等七种学习资源；资源推送根据你的学习画像动态推荐内容；个人中心展示你的六维学习画像。你可以对我说"打开个人中心"来导航到各个页面。'
