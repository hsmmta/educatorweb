 ...
 * <p>对话记忆策略：
 * <ul>
 *   <li><b>近期窗口（最近 10 轮）</b>：保留完整对话原文，直接注入 LLM prompt</li>
 *   <li><b>远期记忆（超过 10 轮）</b>：调用 LLM 生成摘要，摘要代替原文注入 prompt</li>
 * </ul>
 *
 * <p>摘要被缓存为 Chroma 中的特殊记录（role=summary），避免每次对话都重新调用 LLM 摘要。
